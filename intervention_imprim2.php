...
$requeteSQL = mysqli_query($conn, "SELECT * FROM interventions WHERE inter_id = '$numInter' ORDER BY inter_id DESC LIMIT 1") or die('Erreur SQL !'.$requeteSQL.'<br>'.mysqli_error());
$donnees = mysqli_fetch_array($requeteSQL);

$IDclient = $donnees['inter_cli_id'];

$requeteSQL2 = mysqli_query($conn, "SELECT * FROM clients WHERE cli_id = '$IDclient'") or die('Erreur SQL !'.$requeteSQL.'<br>'.mysqli_error());
$donnees2 = mysqli_fetch_array($requeteSQL2);
...
<table width="100%" border="0">
  <tr>
    <td width="50%">
    NOM : <?php echo $donnees2['cli_nom']; ?><br />
	E-mail : <?php echo $donnees2['cli_tel3']; ?>
    </td>
    <td>
    TEL1 : <?php echo $donnees2['cli_tel1']; ?><br />
    TEL2 : <?php echo $donnees2['cli_tel2']; ?>  
    </td>
  </tr>
</table>
   </fieldset>
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="50%">
    &nbsp;<br /><br />
    <b style="text-align:right;"><font size="+2">Signature</font></b><br /><br />    
    &nbsp;<br /><br />    
    </td>
  </tr>												
</table>
