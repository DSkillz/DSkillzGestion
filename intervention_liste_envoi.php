...
if (!$requete)
 { echo "<center>Impossible de se connecter au serveur MySQL</center>"; 
   ...
   print_r($requete->errorInfo());}
    ...
    { header ("Refresh: 2;URL=intervention_liste.php" ); echo "<center><p>La fiche d'intervention a bien &eacute;t&eacute; modifi&eacute;e. Redirection dans 2 secondes...</p></center>//"; }
