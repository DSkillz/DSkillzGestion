...
// Envoi données
$sql = "UPDATE interventions SET inter_status='$status', inter_status_date='$date_status', inter_status_gros='$status_gros', inter_status_piece='$status_matiso', inter_status_qui='$status_qui' WHERE inter_id = '$interID'";
...
if (!$requete)
 { echo "<center>Impossible de se connecter au serveur MySQL</center>"; 
   ...
   print_r($requete->errorInfo());}
    ...
    { header ("Refresh: 2;URL=attente.php"); echo "<center><p>La fiche d'intervention a bien &eacute;t&eacute; modifi&eacute;e. Redirection dans 2 secondes...</p></center>"; }
